            ...
            switch(opcion)
            {
                case "1":
                    ...
                    if(currentPokemon!=null)
                    {
                        ...
                        {
                            System.out.println("You won the battle, do you want to catch the wild " + enemy.getName() + "? Y-Yes/N-No");
                ...
                case "2":
                    ...
                    if (currentPokemon != null)
                    {
                        ...
                        {
                            System.out.println("Evolution name not valid, you re trying to access to an invalid pokedex index");
                        }
                    }
